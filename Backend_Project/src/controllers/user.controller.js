...
const generateAccessAndRefreshTokens = async (userId)=>{
    try {
        ...
        throw new ApiError(500, `This was't supposed to happen while generating tokens... `)
    }
}
...
const updateAccountDetails = asyncHandler(async (rwq, res) => {
...
export {registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, updateAccountDetails, getCurrentUser, updateAvatar, updateUserCoverImage }